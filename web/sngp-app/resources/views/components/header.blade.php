<header x-data="{ open: false }" class="bg-white shadow">
    <div class="max-w-7xl mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-6 text-sm font-medium">
                ...
                <x-nav-link :href="route('pages.marches.liste')" :active="request()->routeIs('pages.marches.liste') || request()->routeIs('pages.marches.show')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden bg-gray-50 border-t border-gray-200">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('pages.marches.liste')" :active="request()->routeIs('pages.marches.liste') || request()->routeIs('pages.marches.show')">
                💼 Marchés & Appels d'offres
